      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary font-medium mb-8">
            ...
            <span>Savings starts with your first location</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
            Add your first location and get AI-generated savings opportunities in minutes.
          </p>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-primary" />
              <span>See savings instantly</span>
            </div>
          </motion.div>
        </motion.div>
      </div>
