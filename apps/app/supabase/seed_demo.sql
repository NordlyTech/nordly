  ...
  if to_regclass('public.billing_records') is not null then
    begin
      insert into public.billing_records (
        id, company_id, location_id, period_start, period_end,
        amount_value, currency, created_at
      )
      values
        ('80000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000003', '2026-01-01', '2026-01-31', 4620, 'SEK', '2026-02-02T08:00:00Z'),
        ('80000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000003', '2026-02-01', '2026-02-28', 4380, 'SEK', '2026-03-02T08:00:00Z'),
        ('80000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000004', '2026-02-01', '2026-02-28', 5980, 'SEK', '2026-03-02T08:10:00Z'),
        ('80000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000005', '2026-01-01', '2026-01-31', 2890, 'SEK', '2026-02-02T08:20:00Z'),
        ('80000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000005', '2026-02-01', '2026-02-28', 2740, 'SEK', '2026-03-02T08:20:00Z'),
        ('80000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000006', '2026-02-01', '2026-02-28', 2310, 'SEK', '2026-03-02T08:30:00Z')
      on conflict (id) do update
      set company_id = excluded.company_id,
          location_id = excluded.location_id,
          period_start = excluded.period_start,
