-- Migration: Add optional energy fields to locations
-- Adds monthly_energy_kwh and monthly_energy_cost as nullable columns.
-- Updates complete_onboarding RPC to accept these optional inputs.

-- 1. Add columns to locations table

ALTER TABLE public.locations
  ADD COLUMN IF NOT EXISTS monthly_energy_kwh NUMERIC NULL,
  ADD COLUMN IF NOT EXISTS monthly_energy_cost NUMERIC NULL;

-- 2. Replace the complete_onboarding function to accept the new optional params.
--    The old function signature changes so we drop the old overload first.
